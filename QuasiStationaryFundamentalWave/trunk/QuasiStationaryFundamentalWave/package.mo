...
email: <a HREF=\"mailto:a.haumer@haumer.at\">a.haumer@haumer.at</a><br>
    ...
    class ReleaseNotes "Release Notes"
      ...
      annotation (Documentation(info="<html>
<p><h5>Version 0.1.0, 2013-08-27</h5></p>
<p><ul>
...
<p><h5>Version 0.2.0, 2013-09-01</h5></p>
<p><ul>
...
<p><h5>Version 0.2.3, 2013-09-25</h5></p>
<p><ul>
<li>Adapted sine / cosine of WS V/f-convverter</li>
</ul></p>
<p><h5>Version 0.2.4, 2013-09</h5></p>
<p><ul>
...
In this example the eddy current losses are implemented in two different ways. Compare the loss dissipation <code>powerb_e.power</code> and <code>powerb_m.power</code> of the two models indicated by power meters.</p>
    ...
    extends Modelica.Icons.ExamplesPackage;
      ...
      equation
        connect(ramp.y, vfController.u)   annotation (Line(points={{-79,-10},{-42,-10}},
                      color={0,0,255}));
        connect(loadTorqueStep.flange, loadInertia.flange_b)
          annotation (Line(points={{80,-80},{70,-80}}, color={0,0,0}));
        ...
        connect(loadTorqueStepQS.flange, loadInertiaQS.flange_b)
          annotation (Line(points={{80,20},{70,20}},   color={0,0,0}));
        ...
        connect(groundQS.pin, starQS.pin_n) annotation (Line(
            points={{-60,50},{-56,50},{-56,50},{-50,50}},
            color={85,170,255},
            smooth=Smooth.None));
