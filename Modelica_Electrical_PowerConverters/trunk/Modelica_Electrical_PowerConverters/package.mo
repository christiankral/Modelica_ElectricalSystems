    ...
    package RectifierBridge2Pulse "Two pulse Graetz bridge"
      ...
      model DiodeBridge2Pulse
        ...
        Modelica.Electrical.Analog.Sources.SineVoltage sinevoltage(V=sqrt(2)*
              ...
              extent={{-10,-10},{10,10}},
              rotation=-90)));
        Modelica_Electrical_PowerConverters.ACDC.DiodeBridge2Pulse rectifier(
            useHeatPort=false)
    ...
    package RectifierCenterTap2Pulse "Center tap rectifier with two pulses"
      ...
      model DiodeCenterTap2Pulse
        ...
        Modelica.Electrical.Analog.Sources.SineVoltage sinevoltage_p(V=sqrt(2)*
              ...
              extent={{-10,-10},{10,10}},
              rotation=-90)));
        Modelica_Electrical_PowerConverters.ACDC.DiodeCenterTap2Pulse rectifier
      ...
      model DiodeCenterTapmPulse
        ...
        Modelica.Electrical.MultiPhase.Sources.SineVoltage sineVoltage_p(
          ...
          freqHz=fill(f, m)) annotation (Placement(transformation(
              ...
              rotation=270,
              origin={-70,10})));
        Modelica_Electrical_PowerConverters.ACDC.DiodeCenterTapmPulse rectifier(
            final m=m)
          annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
        Modelica.Electrical.Analog.Sensors.VoltageSensor voltagesensor
          annotation (Placement(visible=true, transformation(
      ...
      model DiodeBridge2mPulse
        ...
        Modelica.Electrical.MultiPhase.Sources.SineVoltage sineVoltage(
          ...
          freqHz=fill(f, m)) annotation (Placement(transformation(
              ...
              rotation=270,
              origin={-80,-30})));
        Modelica_Electrical_PowerConverters.ACDC.DiodeBridge2mPulse rectifier(
            final m=m)
          annotation (Placement(transformation(extent={{-40,24},{-20,44}})));
        Modelica.Electrical.Analog.Sensors.VoltageSensor voltagesensor
          annotation (Placement(visible=true, transformation(
    ...
    package MultiPhaseTwoLevel "Multi phase two level inverter example"
      ...
      model MultiPhaseTwoLevel_R "Multi phase DC to AC converter with R load"
        ...
        Modelica.Electrical.Analog.Basic.Ground ground annotation (Placement(
              ...
              rotation=180,
              origin={-90,40})));
        Modelica_Electrical_PowerConverters.DCDC.Control.SignalPWM signalPWM[m]
      ...
      annotation (
        ...
        Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
            ...
            Line(
              ...
              smooth=Smooth.None),
            Line(
              points={{20,-20},{22,-20},{24,-20},{24,20},{44,20},{44,-20},{64,-20},
                  {64,-16}},
              color={255,0,255},
              smooth=Smooth.None),
            Line(
              ...
              smooth=Smooth.None),
            Line(
              points={{60,-20},{62,-20},{64,-20},{64,20},{84,20},{84,-20},{84,-20},
                  {88,-20}},
              color={255,0,255},
              smooth=Smooth.None)}),
        Documentation(info="<html>
