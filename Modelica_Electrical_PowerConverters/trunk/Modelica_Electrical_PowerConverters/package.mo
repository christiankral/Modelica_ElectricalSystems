...
<a href=\"modelica://Modelica.Electrical.MultiPhase.Basic.MultiStarResistance\">MultiStarResistance</a> shall be used for grounding the voltage sources. 
  ...
  equation
    ...
    connect(fire_p, thyristor_p.fire) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(fire_n, thyristor_n.fire) annotation (Line(
        points={{60,-120},{60,-20},{-20,-20},{-20,-28},{-20,-28},{-20,-33},{-11,
            -33}},
        color={255,0,255},
        smooth=Smooth.None));
...
<a href=\"modelica://Modelica_Electrical_PowerConverters.Examples.ACDC.ThyristorBridge2mPulse\">Examples.ACDC.ThyristorBridge2mPulse</a>.
  ...
  equation
    ...
    connect(thyristor_p.heatPort, thermalCollector.port_a) annotation (Line(
        ...
        smooth=Smooth.None));
    connect(fire_p, thyristor_p.fire) annotation (Line(
        points={{-60,-120},{-60,46},{-60,46},{-60,46},{-60,47},{-36,47},{-11,47}},
        color={255,0,255},
        smooth=Smooth.None));
    annotation (
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
  ...
  package Control "Control components for DC to DC converters"
    ...
    model SignalPWM
      ...
      Modelica.Blocks.Logical.Less greaterEqual annotation (Placement(
            ...
            rotation=0,
            origin={22,-8})));
      Modelica.Blocks.Logical.And andCondition annotation (Placement(
            transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={-60,70})));
      ...
      Modelica.Blocks.Logical.Not inverse annotation (Placement(transformation(
            ...
            rotation=90,
            origin={52,20})));
      Modelica.Blocks.Logical.And andConditionNot annotation (Placement(
            transformation(
            extent={{-10,10},{10,-10}},
            rotation=90,
            origin={60,70})));
